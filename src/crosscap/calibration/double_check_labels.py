...
Resume: same pattern as classify_calibration. Batch id is written to
...
Usage:
    python -m crosscap.calibration.double_check_labels \\
...
from crosscap.calibration.classify_calibration import (
    JUDGE_USER_TEMPLATE,
    VALID_LABELS,
)
