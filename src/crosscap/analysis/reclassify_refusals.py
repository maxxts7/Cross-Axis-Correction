...
Usage:
    python -m crosscap.analysis.reclassify_refusals                         # process all CSVs
    python -m crosscap.analysis.reclassify_refusals --input cross_axis_generations.csv
    python -m crosscap.analysis.reclassify_refusals --resume                # skip rows that already have a label
    python -m crosscap.analysis.reclassify_refusals --model gpt-5.4-mini    # cheaper model
    python -m crosscap.analysis.reclassify_refusals --concurrency 10
    python -m crosscap.analysis.reclassify_refusals --summary-only          # just print stats from existing outputs
"""
