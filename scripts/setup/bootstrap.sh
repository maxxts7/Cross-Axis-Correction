...
# Resolve project root (this script lives at scripts/setup/), then cd
# there so requirements.txt and pyproject.toml resolve correctly.
cd "$(dirname "$0")/../.."
...
echo ""
echo "  Next steps:"
echo "    ./scripts/calibration/build_calibration.sh both 200 harmbench   # produces data/calibration/"
echo "    ./scripts/launchers/run_llama.sh sanity                         # then the real run"
echo "============================================"
